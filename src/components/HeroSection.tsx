  ...
  return (
    <section className="relative bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white overflow-hidden min-h-screen flex items-center justify-center">
      ...
      <div
        ...
        style={{
          backgroundImage: `url('https://images.unsplash.com/photo-1571837932347-3ff29f264594?q=80&w=1738&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')`,
        }}></div>
      ...
      <div className="container mx-auto px-4 py-32 relative text-center">
        ...
        <p
          ...
          SHAPEL delivers superior metal casting solutions with unmatched precision, quality, and reliability for
