      ...
      <div className="container mx-auto px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid lg:grid-cols-3 gap-12 items-start mb-16">
            ...
            <div className="lg:col-span-2 animate-fade-in-left">
              <div className="space-y-6">
                ...
                {/* Key Achievements */}
                <div className="bg-gradient-to-r from-gray-50 to-gray-100 p-8 rounded-xl shadow-sm">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
            <div className="text-center p-6 bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 hover-scale border border-gray-100">
